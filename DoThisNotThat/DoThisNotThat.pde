...
PFont buttonFont;
color blue = #4966C9; //Note Night Mode Friendly, all of the blue is included
//
void setup() 
{
  //Display Geometry 
...
void draw() 
{
  ...
  fill(white);//Will change the fill() on all shapes the second time repeated in drae(0
  //
}//End draw
//
void keyPressed() {
